<%-- 
    Document   : Authentication4
    Created on : 7 Dec, 2025, 3:15:30 PM
    Author     : jones
--%>
...
<head>
    ...
    <style>
        ...
        /* Main title slide down animation */
        ...
        /* Doctor verification special animation */
        .display-1 {
            animation: doctorTitlePulse 2s ease-in-out infinite, titleSlideDown 0.8s cubic-bezier(0.175, 0.885, 0.32, 1.275) 0.2s both;
        }
        
        @keyframes doctorTitlePulse {
            0%, 100% { opacity: 1; }
            50% { opacity: 0.9; }
        }
...
<body>
    <img class="bg-img" src="img30.png" alt="Background image">
    <div class="bg-tint"></div>

    <div class="display-1 text-center m-4">DOCTOR AUTHENTICATION</div>
    
    <div class="login-box">
        <h2>Doctor Verification</h2>
        <form method="post" action="admincheck3">
            <div class="user-box">
                <input type="password" name="t1" required="">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add doctor-specific animation for the title
            const title = document.querySelector('.display-1');
            title.addEventListener('mouseenter', function() {
                this.style.animation = 'doctorTitlePulse 1s ease-in-out, titleSlideDown 0.8s cubic-bezier(0.175, 0.885, 0.32, 1.275) 0.2s both';
            });
            
            title.addEventListener('mouseleave', function() {
                this.style.animation = 'doctorTitlePulse 2s ease-in-out infinite, titleSlideDown 0.8s cubic-bezier(0.175, 0.885, 0.32, 1.275) 0.2s both';
            });
            
            // Auto-focus on first input with animation
            setTimeout(() => {
                const firstInput = inputs[0];
                if (firstInput) {
                    firstInput.focus();
                    firstInput.parentElement.style.animation = 'inputFadeIn 0.6s ease-out 0.6s both, pulseFocus 1s ease-in-out';
                    setTimeout(() => {
                        firstInput.parentElement.style.animation = 'inputFadeIn 0.6s ease-out 0.6s both';
                    }, 1000);
                }
            }, 1500);
        });
